...
namespace Shooping.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Santiago", "Acuña", "snt-26@hotmail.com", "321 777 5042", "Carrera Monda", "sant.jpg", UserType.Admin);
            await CheckUserAsync("2020", "Phill", "Spencer", "phill@yopmail.com", "311 333 4910", "Calle Neas", "phill.jpg", UserType.User);
            ...
            string email, string phone, string address, string image, UserType userType)
        {
            ...
            if (user == null)
            {
                ...
                await _userHelper.AddUserAsync(user, "KMZ1530kmz");
